...
class Jugador(Programago):
    ...
    @abstractmethod
    def celebrar(self):
        print(f"{self.nombre}: Wohoo! ")


class Buscador(Jugador):

    def __init__(self, nombre, saludo, numero_polera):
        Jugador.__init__(self, nombre, saludo, numero_polera)
    ...
    def competir(self):
        return self.velocidad * p.PONDERADOR_VELOCIDAD_BUSCADOR + \
...
class Golpeador(Jugador):
    ...
    def competir(self):
        return self.velocidad * p.PONDERADOR_VELOCIDAD_GOLPEADOR + \
...
class Cazador(Jugador):
    ...
    def competir(self):
        return self.velocidad * p.PONDERADOR_VELOCIDAD_CAZADOR + \
