...
class CazadorGryffindor(EstudianteGryffindor, Cazador):
    ...
    def competir(self):
        return super().competir() + self.valor * 0.2
...
class GolpeadorGryffindor(EstudianteGryffindor, Golpeador):
    ...
    def competir(self):
        return super().competir() + self.ambicion * 0.2
...
class BuscadorGryffindor(EstudianteGryffindor, Buscador):
    ...
    def competir(self):
        return super().competir() + self.inteligencia * 0.2
