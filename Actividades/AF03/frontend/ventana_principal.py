...
class VentanaPrincipal(QMainWindow):
    ...
    def crear_botones(self):
        ...
        self.boton_tarea_1 = QPushButton("Tarea 1", self)
        self.boton_tarea_2 = QPushButton("Tarea 2", self)

        self.boton_tarea_1.clicked.connect(self.boton_tarea_clickeado)
        self.boton_tarea_2.clicked.connect(self.boton_tarea_clickeado)
        self.cambiar_diseno_botones(self.boton_tarea_1)
        self.cambiar_diseno_botones(self.boton_tarea_2)
        vbox.addWidget(self.boton_tarea_1)
        vbox.addWidget(self.boton_tarea_2)
    ...
    def tarea_terminada(self, info_tarea):
        ...
        # Completar
        if numero_tarea == 1:
            self.boton_tarea_1.setDisabled(True)
        else:
            self.boton_tarea_2.setDisabled(True)
