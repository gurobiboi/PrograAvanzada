...
class Cliente:
    ...
    def enviar(self, mensaje):
        ...
        """
        # print(self.socket_cliente)
        mensaje_codificado = self.codificar_mensaje(mensaje)
        largo = len(mensaje_codificado)
        self.socket_cliente.sendall(largo.to_bytes(5, byteorder='little') + mensaje_codificado)
    ...
    def recibir(self):
        ...
        """
        largo_archivo = int.from_bytes(self.socket_cliente.recv(5), byteorder='little')
        datos = bytearray()
        ...
        mensaje_decodificado = self.decodificar_mensaje(datos)
